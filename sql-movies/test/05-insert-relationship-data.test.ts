...
const insertMovieGenres = (
  ...
  let filtered = genreRows.filter((row) => genres.includes(row.genre));
  return(
...
const insertMovieActors = (
  ...
  let filtered = actorRows.filter((row) => actors.includes(row.full_name));
  return(
...
const insertMovieDirectors = (
  ...
  let filtered = directorRows.filter((row) => directors.includes(row.full_name));
  return(
...
const insertMovieKeywords = (
  ...
  let filtered = keywordRows.filter((row) => keywords.includes(row.keyword));
  return(
...
const insertMovieProductionCompanies = (
  ...
  let filtered = productionCompanyRows.filter((row) => productionCompanies.includes(row.company_name));
  return(
